...
export default function CustomDetailTDM({ id }: { id: string }) {
    ...
    try {
      ...
      if (stored) {
        ...
        if (found) {
          ...
          if (!found.mode) found.mode = 'チームデスマッチ';
        }
        setCustom(found);
      }
    } catch {
        ...
        <div className="mx-auto flex max-w-xl items-center justify-between px-4 py-3">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-zinc-400">{custom.mode} ・ {custom.players.length}人参加</p>
            </div>
          </div>
